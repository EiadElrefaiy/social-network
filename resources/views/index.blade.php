            ...
            <div id="post-modal-data" class="card card-block card-stretch card-height">
               ...
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     <div class="user-img">
                        <img src="../assets/images/user/default.jpg" alt="userimg" class="avatar-60 rounded-circle">
                     </div>
                  ...
                  <div class="modal-dialog   modal-fullscreen-sm-down">
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <div class="d-flex align-items-center">
                              <div class="user-img">
                                 <img src="../assets/images/user/default.jpg" alt="userimg" class="avatar-60 rounded-circle img-fluid">
                              </div>
            ...
            <div class="card card-block card-stretch card-height">
               <div class="card-body">
                  <div class="post-item">
                     <div class="d-flex justify-content-between">
                        <div class="me-3">
                           <img class="rounded-circle img-fluid avatar-60" src="../assets/images/user/default.jpg" alt="">
                        </div>
                        <div class="w-100">
                           <div class="d-flex justify-content-between">
                              <div class="">
